...
public class KontaktlistView extends MainFrame {
	...
	public void run () {
		...
		/*
		 * MenÃ¼leiste mit den Buttons fÃ¼r die Anlage von einer neuen Kontaktliste und dem LÃ¶schen einer Kontaktliste erzeugen
		...
		/*
		 * CellList fÃ¼r die Anzeige der Kontaktlisten eines Users wird erzeugt
		 */
		...
		// Wird angezeit, wenn der CellTable keine Daten enthÃ¤lt (Testzweck)
		...
		/*		     * CheckBoxen fÃ¼r die Auswahl mehrerer Kontakte anlegen. Hiermit kÃ¶nnen mehrere Kontakte gleichzeitig
